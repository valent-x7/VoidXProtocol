...
class Win:
    ...
    def setup_UI(self):
        ...
        self.retry_btn = ButtonUI(self.screen, (self.screen_w / 2, self.screen_h / 2), "#312c85", "#242161",
                                self.button_font, "Retry", 300, 90, self.button_clicked_sound)
        self.main_menu_btn = ButtonUI(self.screen, (self.screen_w / 2, self.screen_h / 2 + 110), "#312c85", "#242161",
